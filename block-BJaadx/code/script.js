...
//    - Select the first `li` element inside the `ul` with class `topics` and change the innerText to `all about document`
     let li = document.querySelector(".topics").firstElementChild;
...
let inputCheckbox = document.getElementById("remeber");
...
allTopics.forEach(elm => console.log(elm));
...
let text = document.querySelector(".topics").firstElementChild;
text.innerText = "This is the first child element"
// 25. Select the last element child of the element stored in `topics` variable (#5) and log the `typeof` the element.
let type = document.querySelector(".topics").lastElementChild;
...
let parent = document.querySelector("fieldset").parentElement;
