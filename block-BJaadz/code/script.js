...
allHrsArray.filter(elem => elem.className = "image").forEach(elem => elem.style.border = "2px solid purple");
...
[...boxOne.children].forEach(elem => elem.remove());
...
box2.innerText = "Append inserts as last child";
document.querySelector(".two").append(box2);
...
box3.innerText = "Prepend inserts as first child";

document.querySelector(".three").prepend(box3);
...
inputElm.placeholder = "Enter your mail";
